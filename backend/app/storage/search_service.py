...
logger = logging.getLogger('microfish.search')
...
class SearchService:
    ...
    def _run_edge_vector_search(
        self, session: Any, graph_id: str, query_vector: List[float], limit: int
    ) -> List[Dict[str, Any]]:
    ...
    def _run_edge_keyword_search(
        self, session: Any, graph_id: str, query: str, limit: int
    ) -> List[Dict[str, Any]]:
