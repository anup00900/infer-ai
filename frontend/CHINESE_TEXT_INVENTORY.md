# Microfish Frontend - Chinese Text Translation Inventory

## Overview
Complete inventory of Chinese text found in the Microfish frontend application that requires translation to English.
...
- `<meta name="description" content="Microfish - 社交媒体舆论模拟系统" />` (Microfish - Social Media Opinion Simulation System)
- `<title>Microfish - 预测万物</title>` (Microfish - Predict Everything)
