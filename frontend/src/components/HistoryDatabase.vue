      ...
      >
        ...
        <div class="card-footer">
          ...
          <div class="card-footer-right">
            ...
            <button class="delete-btn" @click.stop="confirmDelete(project, $event)" title="Delete simulation">&#10005;</button>
          </div>
        </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-header">
              ...
              <div class="modal-header-actions">
                <button class="modal-delete-btn" @click="confirmDelete(selectedProject, $event)" title="Delete simulation">Delete</button>
...
const confirmDelete = async (project, event) => {
  ...
  if (!confirm(`Delete simulation ${formatSimulationId(project.simulation_id)}? This cannot be undone.`)) return
...
.gradient-overlay {
  ...
  bottom: 0;
  background: 
    linear-gradient(to right, rgba(10, 14, 26, 0.9) 0%, transparent 15%, transparent 85%, rgba(10, 14, 26, 0.9) 100%),
    linear-gradient(to bottom, rgba(10, 14, 26, 0.8) 0%, transparent 20%, transparent 80%, rgba(10, 14, 26, 0.8) 100%);
  pointer-events: none;
}
...
/* Dark Morandi palette for file tags */
.file-tag.pdf { background: rgba(166, 90, 90, 0.2); color: #d4908f; }
.file-tag.doc { background: rgba(90, 126, 166, 0.2); color: #8ab4d4; }
.file-tag.xls { background: rgba(90, 166, 104, 0.2); color: #8ad49e; }
.file-tag.ppt { background: rgba(166, 129, 90, 0.2); color: #d4b48a; }
.file-tag.txt { background: rgba(117, 117, 117, 0.2); color: #a0a0a0; }
.file-tag.code { background: rgba(129, 90, 166, 0.2); color: #b48ad4; }
.file-tag.img { background: rgba(90, 166, 166, 0.2); color: #8ad4d4; }
.file-tag.zip { background: rgba(166, 155, 90, 0.2); color: #d4cb8a; }
.file-tag.other { background: var(--bg-tertiary); color: var(--text-muted); }
...
.modal-progress.completed { color: var(--success); background: rgba(16, 185, 129, 0.15); }
.modal-progress.in-progress { color: #F59E0B; background: rgba(245, 158, 11, 0.15); }
.modal-progress.not-started { color: var(--text-muted); background: var(--bg-tertiary); }
