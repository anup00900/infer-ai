    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Based on the generated ontology, automatically chunk documents and invoke Azure OpenAI GraphRAG to build knowledge graphs, extract entities and relationships, and form temporal memory and community summaries
          </p>
...
.badge.accent { background: var(--accent-blue); color: var(--white); }
