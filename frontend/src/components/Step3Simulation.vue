...
.breakdown-divider { color: var(--border-secondary); }
...
.timeline-axis {
  ...
  bottom: 0;
  width: 1px;
  background: var(--border-primary); /* Cleaner line */
  transform: translateX(-50%);
}
...
.timeline-item.twitter .marker-dot { background: var(--accent-blue); }
.timeline-item.reddit .marker-dot { background: var(--accent-cyan); }
.timeline-item.twitter .timeline-marker { border-color: var(--accent-blue); }
.timeline-item.reddit .timeline-marker { border-color: var(--accent-cyan); }
...
.badge-post { background: var(--bg-tertiary); color: var(--text-primary); border-color: var(--border-primary); }
.badge-comment { background: var(--bg-tertiary); color: var(--text-secondary); border-color: var(--border-primary); }
.badge-action { background: var(--bg-card); color: var(--text-secondary); border: 1px solid var(--border-primary); }
.badge-meta { background: var(--bg-secondary); color: var(--text-muted); border: 1px dashed var(--border-secondary); }
...
@keyframes ripple {
  0% { transform: scale(0.8); opacity: 1; border-color: var(--border-secondary); }
  100% { transform: scale(2.5); opacity: 0; border-color: var(--border-primary); }
}
